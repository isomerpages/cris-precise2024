								...
								<div class="speakers px-2">
									<div style="padding-left: 10px" class="row">
										<div class="col is-12 prog-speaker">
											<div class="row">
												<div class="col is-2">
														<img class="speaker-image" src="/images/Speaker%20Photos%202024/Placeholder.png" alt="Illumina">
												</div>
												<div style="display: flex; justify-content: center; flex-direction: column;flex:1;" class="col is-12">
													<div class="speaker-name text-ellipsis">
															<b style="color: #000; font-size: 16px;">Presentation by Illumina</b></div>
													<div style="line-height: 16px" class="text-ellipsis speaker-position">
													</div>
												</div>
											</div>
								...
								<div class="speakers px-2">
									<div style="padding-left: 10px" class="row">
										<div class="col is-12 prog-speaker">
											<div class="row">
												<div class="col is-2">
														<img class="speaker-image" src="/images/Speaker%20Photos%202024/Placeholder.png" alt="Olink">
												</div>
												<div style="display: flex; justify-content: center; flex-direction: column;flex:1;" class="col is-12">
													<div class="speaker-name text-ellipsis">
															<b style="color: #000; font-size: 16px;">Presentation by Olink</b></div>
													<div style="line-height: 16px" class="text-ellipsis speaker-position">
													</div>
												</div>
											</div>
									...
									<div style="padding-left: 10px" class="row">
										<div class="col is-12 prog-speaker">
											<div class="row">
												<div class="col is-2">
														<img class="speaker-image" src="/images/Speaker%20Photos%202024/Placeholder.png" alt="Oxford Nanopore Tech">
												</div>
												<div style="display: flex; justify-content: center; flex-direction: column;flex:1;" class="col is-12">
													<div class="speaker-name text-ellipsis">
															<b style="color: #000; font-size: 16px;">Presentation by Oxford Nanopore Tech</b></div>
													<div style="line-height: 16px" class="text-ellipsis speaker-position">
													</div>
											</div>
										</div>
